...
static float friction_RC=0.03;//0.02
static float friction_dt=0;

// void DJMotorsetlvbo(DJIMotorInstance *motor, float sef)
// {
//     static uint32_t friction_dt_cnt=0;
//     static float last_sef;
//     friction_dt = DWT_GetDeltaT(&friction_dt_cnt);
//     sef =
//         sef * friction_dt /(friction_RC + friction_dt) +
//         last_sef * friction_RC /(friction_RC + friction_dt);
//         last_sef=sef;
// }
